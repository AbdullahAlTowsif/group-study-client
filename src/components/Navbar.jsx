...
const Navbar = () => {
  ...
  return (
    <div className={`${theme === "dark" ? "bg-black text-white" : "bg-gray-100 text-gray-800"
      }  sticky top-0 z-10`}>
      <div
      ...
      >
        <div className="navbar shadow-sm px-4">
          ...
          <button
            onClick={toggleTheme}
            className={`px-4 py-2 rounded hidden lg:block ${theme === "dark"
          ...
          <div className="hidden lg:flex items-center">
            ...
            {user && (
              <div className="dropdown dropdown-end z-50">
                ...
                <ul
                  tabIndex={0}
                  className={`menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52 ${theme === "dark" ? "bg-gray-800 text-white" : "bg-base-100 text-gray-800"
                    }`}
                >
                  <li>
                  ...
                  <li className="mt-2">
                    <button
                      onClick={logOut}
                      className={`block text-center ${theme === "dark" ? "bg-gray-700 text-white" : "bg-gray-200 text-gray-800"
                        }`}
                    >
                      Logout
                    </button>
